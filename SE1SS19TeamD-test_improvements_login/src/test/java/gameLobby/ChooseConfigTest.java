...
public class ChooseConfigTest extends ApplicationTest {
    ...
    private GameLobbyController_v2 gameLobbyController;
    ...
    public void start(Stage stage) throws IOException {
        try {
            ...
            screenFXML = new FXMLLoad("/gameLobby/GameLobbyScreen_v2.fxml", new GameLobbyController_v2());
            gameLobbyController = screenFXML.getController(GameLobbyController_v2.class);
    ...
    public void TestChooseConfig(){
        ...
        // Alice has logged in and created a game named "Alice's Game" with 4 players.
            ...
            armyManagerController = screenFXML.getController(GameLobbyController_v2.class).armymanagerFXML.getController(ArmyManagerController.class);
