...
public class GameField 
{
   ...
   public static final String PROPERTY_gameFieldLoaded = "gameFieldLoaded";

   private boolean gameFieldLoaded;

   public boolean getGameFieldLoaded()
   {
      return gameFieldLoaded;
   }

   public GameField setGameFieldLoaded(boolean value)
   {
      if (value != this.gameFieldLoaded)
      {
         boolean oldValue = this.gameFieldLoaded;
         this.gameFieldLoaded = value;
         firePropertyChange("gameFieldLoaded", oldValue, value);
      }
      return this;
   }
