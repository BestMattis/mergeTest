...
public class EditTests extends ApplicationTest {
    ...
    private  ArrayList<JSONObject> allDifferentUnitTypes = armyFXML.getController(ArmyManagerController.class).getAllDifferentUnitTypes();
    ...
    public void start(Stage stage){
        ...
        for(int i = 0; i < 7; ++i){
            ...
            armyFXML.getController(ArmyManagerController.class).addUnit(unitType.getString("id"));
        }
    ...
    public void intoTest(){
        ...
        FxAssert.verifyThat(armyFXML.getController(ArmyManagerController.class).getUnits().get(7), is(allDifferentUnitTypes.get(7%allDifferentUnitTypes.size())));
    }
